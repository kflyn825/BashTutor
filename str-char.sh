...
if [[ $len1 -gt $len2 ]] ; then echo str1 is longer
elif [[ $len1 -eq $len2 ]] ; then echo both are same length
else echo str2 is longer
fi 

if [[ $str1 == $str2 ]] ; then echo str1 is same as str2
else  echo str1 is NOT same as str2
fi
